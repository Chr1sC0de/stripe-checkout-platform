...
class InfrastructureStack(Stack):
    def __init__(
        ...
        **kwargs,
        ...
        cognito_domain_prefix = f"{utils.COMPANY}-{utils.DEVELOPMENT_ENVIRONMENT}-users"
        ...
        ssm.StringParameter(
            ...
            parameter_name=f"/{utils.COMPANY}/{utils.DEVELOPMENT_ENVIRONMENT}/user-pool-provider-url",
        ...
        ssm.StringParameter(
            ...
            parameter_name=f"/{utils.COMPANY}/{utils.DEVELOPMENT_ENVIRONMENT}/user-pool-cognito-domain-url",
        ...
        ssm.StringParameter(
            self,
            "ssm_user_pool_id",
            parameter_name=f"/{utils.COMPANY}/{utils.DEVELOPMENT_ENVIRONMENT}/user-pool-id",
        ...
        ssm.StringParameter(
            ...
            parameter_name=f"/{utils.COMPANY}/{utils.DEVELOPMENT_ENVIRONMENT}/user-pool-client-id",
        ...
        ssm.StringParameter(
            ...
            parameter_name=f"/{utils.COMPANY}/{utils.DEVELOPMENT_ENVIRONMENT}/user-pool-signing-key",
    ...
    def add_integration_clients_to_user_pool(
        ...
        if api_url is not None:
            callback_urls.extend(
                [
                    f"{api_url}docs",
                    f"{api_url}docs/oauth2-redirect",
        ...
        return user_pool.add_client(
            ...
            user_pool_client_name=f"{utils.COMPANY}-{utils.DEVELOPMENT_ENVIRONMENT}-client-pool",
    ...
    def create_user_pool(self: Stack) -> cognito.UserPool:
        return cognito.UserPool(
            self,
            "user_pool",
            user_pool_name=f"{utils.COMPANY}-{utils.DEVELOPMENT_ENVIRONMENT}-user-pool",
